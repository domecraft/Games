...
adjective = ["witty", "crazy", "impeccable", "idiotic", "angsty", "arrogant", "fascinating", "slightly arousing", "charming", "surprisingly helpful", "incestuous", "curious", "weaboo", "scandalous", "witty", "comical", "adorable", "perverse", "sweet", "preposterous"]
noun = ["swine", "Romeo and Juliet", "peacocks", "feuding families" ,"star-crossed lovers", "Hamlet", "kings of England", "Hamlet's mother", "pack of ruffians", "gang of peddlers", "kings and queens", "merrymen", "town crier", "harem of women"]
